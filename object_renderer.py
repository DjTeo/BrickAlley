...
class ObjectRenderer:
    ...
    def __init__(self, game):
        ...
        self.right_hand_mid = Helper.LoadSprite('rightHandMid.png', 
                                            (GAME_WIDTH * 0.3, GAME_HEIGHT * 0.6))
        self.left_hand_mid = Helper.LoadSprite('leftHandMid.png', 
                                            (GAME_WIDTH * 0.3, GAME_HEIGHT * 0.6))
        
        self.left_hand_up = Helper.LoadSprite('leftHandUp.png', 
                                            (GAME_WIDTH * 0.4, GAME_HEIGHT * 0.8))
        self.right_hand_up = Helper.LoadSprite('rightHandUp.png', 
                                            (GAME_WIDTH * 0.4, GAME_HEIGHT * 0.8))
        
        self.time_pre = pygame.time.get_ticks()
        self.animation_stages = 6
        self.animation_frequency = 200
        # self.digit_size = 90
    ...
    def draw_hands(self, screen):
        ...
        if (
            ...
            screen.blit(self.right_hand_up,
              ...
              self.animation_frequency) % self.animation_stages == 5:
            screen.blit(self.left_hand,
                        (GAME_WIDTH / 4,GAME_HEIGHT*0.65))
            screen.blit(self.right_hand_mid,
                        (GAME_WIDTH * 0.5, GAME_HEIGHT /2))
