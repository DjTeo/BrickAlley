...
class Player:
    ...
    #DIFFICULTY MOD
    def increase_dif(self):
        if int(self.x)%10==0 and self.forward_speed<MAX_SPEED and self.respawn_timer>MIN_RESPAWN:
            self.forward_speed+=0.05
            self.respawn_timer-=3
        #print(self.respawn_timer,self.forward_speed)
